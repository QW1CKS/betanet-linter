...
describe('BetanetComplianceChecker', () => {
  ...
  // Total checks increased to 23 after Step 10 (binary meta, TLS static template calibration, negative assertions)
  ...
  // With 23 total, excluding id 10 should yield 22
  expect(result.checks).toHaveLength(22); // 23 total minus excluded 10
