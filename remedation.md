...
6. [~] Governance & ledger evidence validation logic (initial: ingestion via --governance-file, artifact checks 15 (governance caps) & 16 (ledger finality/quorum) added; pending deeper quorum certificate parsing, weight mapping, historical diversity dataset integration).
