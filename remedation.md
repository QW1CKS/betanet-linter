...
9. [~] Full dynamic harness expansion (initial: simulated rekey event & HTTP/2 adaptive jitter metrics with Checks 19 & 20; pending: real transcript capture, HTTP/3, calibration baselines, statistical variance tests).
